      ...
      <section className=" z-50">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          <a
            ...
            role="alert"
          >
            <span className="text-xs bg-primary rounded-full text-white px-4 py-1.5">
              New
            </span>
            <svg
         ...
         hover:border-pink-500/10 hover:shadow-pink-500/10"
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-600">
              Select your interview preferences, including the type of round,
              role, technology stack, and experience level. This tailored setup
              ensures the AI generates relevant and challenging questions suited
              to your needs.
            </p>
          </a>
          ...
          >
            ...
            <h2 className="mt-4 text-xl font-bold text-black">
              Engage in a Realistic Mock Interview{" "}
            </h2>

            <p className="mt-1 text-sm text-gray-600">
              Begin your interview with AI-generated questions based on your
              chosen parameters. Answer verbally as the AI listens and interacts
              with you, providing a realistic simulation of a live interview.
            </p>
          </a>
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-600">
              Review your interview with a detailed score and feedback. Compare
              your answers with the correct responses and receive personalized
              insights to help you improve and prepare for real interviews.
            </p>
          </a>
        </div>
